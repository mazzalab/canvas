setwd("/home/m.truglio/PycharmProjects/canvas/resources/")
...
count_genes_in_column <- function(column_tobe_counted){
  ...
  require(xlsx)
  annotation_file = "input_output/annotated_cnv_file_14022018_500Kb.xlsx" #questo viene dallo script py
  # ok va su mongodb
  epilessia_inside <- annotate_gene(annotation_file, "gene_inside", "epilessia_genelist.txt") #ok
  ...
  IDa_inside <- annotate_gene(annotation_file, "gene_inside", "ID_a_genelist.txt") #ok
  ...
  IDb_inside <- annotate_gene(annotation_file, "gene_inside", "ID_b_genelist.txt") #ok
  ...
  malformazioni_inside <- annotate_gene(annotation_file, "gene_inside", "malformazioni_genelist.txt") #ok
  ...
  dosage_inside <- annotate_gene(annotation_file, "gene_inside", "dosage_sensitive_genelist.txt") #ok
  ...
  onologhi_inside <- annotate_gene(annotation_file, "gene_inside", "onologhi_genelist.txt") #ok
  ...
  mendeliome_inside <- annotate_gene(annotation_file, "gene_inside", "mendeliome_genelist.txt") #ok
  ...
  ASD_inside <- annotate_gene(annotation_file, "gene_inside", "ASD_genelist.txt") #ok
  ...
  autism_pubmed_inside <- annotate_gene(annotation_file, "gene_inside", "pubmed_09-02-2018_autism_genelist.txt") #ok
  ...
  brain_malformation_pubmed_inside <- annotate_gene(annotation_file, "gene_inside", "pubmed_09-02-2018_brain_malformations_genelist.txt") #ok
  brain_malformation_pubmed_cross <- annotate_gene(annotation_file, "gene_cross", "pubmed_09-02-2018_brain_malformations_genelist.txt")
  brain_malformation_pubmed_distal <- annotate_gene(annotation_file, "gene_distal", "pubmed_09-02-2018_brain_malformations_genelist.txt")
  
  epilepsy_pubmed_inside <- annotate_gene(annotation_file, "gene_inside", "pubmed_09-02-2018_epilepsy_or_seizures_genelist.txt") #ok
  epilepsy_pubmed_cross <- annotate_gene(annotation_file, "gene_cross", "pubmed_09-02-2018_epilepsy_or_seizures_genelist.txt")
  epilepsy_pubmed_distal <- annotate_gene(annotation_file, "gene_distal", "pubmed_09-02-2018_epilepsy_or_seizures_genelist.txt")
  
  ID_pubmed_inside <- annotate_gene(annotation_file, "gene_inside", "pubmed_09-02-2018_intellectual_disability_genelist.txt") #ok
  ID_pubmed_cross <- annotate_gene(annotation_file, "gene_cross", "pubmed_09-02-2018_intellectual_disability_genelist.txt")
  ID_pubmed_distal <- annotate_gene(annotation_file, "gene_distal", "pubmed_09-02-2018_intellectual_disability_genelist.txt")
  #########################
  ...
  library(xlsx)
  write.xlsx(x = f, file = "/home/m.truglio/PycharmProjects/canvas/resources/input_output/annotated_cnv_file_14022018_500Kb_plus.xlsx", sheetName = "Annotated_CNV", row.names = FALSE)
#}
